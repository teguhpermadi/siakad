			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					...
					<div class="form-group">
						...
						<input type="text" name="kode_kelas" value="<?php echo ($this->input->post('kode_kelas') ? $this->input->post('kode_kelas') : $kelas['kode_kelas']); ?>" class="form-control" id="kode_kelas" />
					</div>
