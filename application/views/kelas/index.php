			...
			<table id="datatable-kelas" class="table table-striped table-bordered" style="width:100%">
				...
				<?php foreach ($kelas as $k) { ?>
					<tr>
						...
						<td>
							<a href="<?php echo site_url('kelas/edit/' . $k['id']); ?>" class="btn btn-info btn-xs">Edit</a>
							<a href="<?php echo site_url('kelas/remove/' . $k['id']); ?>" class="btn btn-danger btn-xs">Delete</a>
						</td>
					</tr>
				<?php } ?>
				<tfoot>
