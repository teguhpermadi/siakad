<?php echo form_open('kompetensi_dasar/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="ki" value="<?php echo $this->input->post('ki'); ?>" class="form-control" id="ki" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="kd" value="<?php echo $this->input->post('kd'); ?>" class="form-control" id="kd" />
