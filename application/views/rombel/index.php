			...
			<div class="col-sm-4 mb-3">
				<div class="card shadow">
					<div class="card-body">
						...
						<div class="mb-2">
							<span class="badge badge-info">Total: <?= $jml_siswa; ?></span>
						...
						<div class="btn-group dropup">
							...
							<div class="dropdown-menu">
								<!-- Dropdown menu links -->
								<a href="#" class='dropdown-item'>Cetak Absensi</a>
								<a href="<?= base_url('rombel/remove/' . $k['id_kelas']); ?>" class='dropdown-item text-danger'>Hapus Rombel</a>
							</div>
						</div>
					</div>
				</div>
