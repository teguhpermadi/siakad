					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="number" name="tahun_masuk" value="<?php echo ($this->input->post('tahun_masuk') ? $this->input->post('tahun_masuk') : $siswa['tahun_masuk']); ?>" class="form-control" id="tanggal_masuk" />
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
