	...
	<div class="row">
		<div class="col-8">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<?php echo form_open('walikelas/edit/'.$walikelas['id'],array("class"=>"form-horizontal")); ?>
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<select name="id_guru" class="form-control">
                                ...
                                {
                                    $selected = ($guru['id'] == $walikelas['id_guru']) ? ' selected="selected"' : "";
					...
					<div class="form-group">
						<label for="id_kelas" class="col-md-4 control-label"><span
						...
						<div class="col-md-8">
							<select  class="form-control" disabled>
                                ...
                                {
                                    $selected = ($kelas['id'] == $walikelas['id_kelas']) ? ' selected="selected"' : "";

                                    echo '<option value="'.$kelas['id'].'" '.$selected.'>'.$kelas['nama'].'</option>';
                                } 
                                ?>
                            </select>
                            <input type="hidden" name="id_kelas" value='<?= $walikelas['id_kelas']; ?>'>
