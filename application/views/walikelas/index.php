							...
							<tbody>
								<?php foreach ($walikelas as $w) { ?>
									<tr>
										...
										<td><?= $w['nama_guru']; ?></td>
										<td>
											<a href="<?php echo site_url('walikelas/edit/' . $w['id']); ?>" class="btn btn-info btn-sm">Edit</a>
											<a href="<?php echo site_url('walikelas/remove/' . $w['id']); ?>" class="btn btn-danger btn-sm">Delete</a>
										</td>
									</tr>
								<?php } ?>
							</tbody>
