...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 01, 2020 at 04:01 AM
...
INSERT INTO `kompetensi_dasar` (`id`, `id_tahun`, `id_mapel`, `tingkat`, `id_guru`, `jenis`, `kd`) VALUES
(1, 2, 2, 10, 75, 'pengetahuan', 'Maecenas lacinia arcu suscipit dignissim feugiat.'),
(2, 2, 2, 11, 75, 'pengetahuan', 'Mauris nec ante ornare libero commodo condimentum.'),
(3, 2, 2, 10, 75, 'pengetahuan', 'Donec dictum libero in hendrerit porttitor.'),
(4, 2, 2, 11, 75, 'pengetahuan', 'Donec in eros ullamcorper quam congue lacinia sed at ligula.'),
(5, 2, 2, 10, 75, 'pengetahuan', 'Ut maximus turpis eget est auctor blandit.'),
(6, 2, 2, 11, 75, 'pengetahuan', 'Aliquam nec sem imperdiet, congue metus nec, consequat arcu.'),
(7, 2, 2, 10, 75, 'pengetahuan', 'Cras sed quam eget elit gravida venenatis ut et eros.'),
(8, 2, 2, 11, 75, 'pengetahuan', 'Maecenas ut enim interdum, laoreet ex a, pulvinar mauris.'),
(9, 2, 2, 10, 75, 'keterampilan', 'Praesent fermentum ipsum a ex pulvinar, non eleifend nisl eleifend.'),
(11, 2, 2, 10, 75, 'keterampilan', 'Donec sit amet purus ut tortor tempor viverra.'),
(13, 2, 2, 10, 75, 'keterampilan', 'Maecenas at est eu neque varius facilisis.'),
(15, 2, 2, 10, 75, 'keterampilan', 'Nulla sed ante vitae lectus consectetur lacinia maximus vel leo.'),
(20, 2, 1, 10, 75, 'keterampilan', 'ssss');
...
INSERT INTO `nilai` (`id`, `id_tahun`, `id_mapel`, `id_siswa`, `id_kd`, `nilai`) VALUES
(1, 2, 2, 28, 2, 90),
(2, 2, 2, 16, 2, 90),
(3, 2, 2, 14, 2, 80),
(4, 2, 2, 30, 2, 60),
...
(1, '127.0.0.1', 'administrator', '$2y$12$LDGmMnMv/vfhEGd/lVssTuEjTNccQH.QLYYSKHgPg..6sycG9azFu', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1596254846, 1, 'Admin', 'istrator', 'ADMIN', '0'),
(9, '::1', 'achartman22@guardian.co.uk', '$2y$10$omkTHm/xovhxQbH7BlZKXuOel5ZnjdkwMUpr8SUxVc92P25/rW5/2', 'achartman22@guardian.co.uk', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1582721880, 1598911568, 1, 'Abra', 'Chartman', NULL, '8385959502'),
(10, '::1', 'ababcock3x@hc360.com', '$2y$10$nc2uZpn0lFRDsHKZh10B8er96I1iYpbqlrBitqPudgRkM4dLlol02', 'ababcock3x@hc360.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1582722180, 1596336552, 1, 'Adelaide', 'Babcock', NULL, '3079067532'),
(11, '::1', 'abrantzend@goodreads.com', '$2y$10$T9h5yWVlcnAnq9LJHsgMuuJGlfRCHHfsxpHi2zR3lh92KNDYT/FBe', 'abrantzend@goodreads.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1582722180, 1596336607, 1, 'Adoree', 'Brantzen', NULL, '2556755890'),
(12, '::1', 'avan2j@technorati.com', '$2y$10$34esYJswErJNxyVQvb/hgOg3SM7h22lIGmYpdIv3b1olJruEKOw3m', 'avan2j@technorati.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1582722240, 1596336635, 1, 'Adrianne Van', 'Waadenburg', NULL, '3769254926'),
...
ALTER TABLE `nilai`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id_tahun` (`id_tahun`,`id_siswa`,`id_mapel`,`id_kd`) USING BTREE;
